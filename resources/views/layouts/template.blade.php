...
<body>
    ...
    <div class="loaderz" id="loader">
        <div class="inside-loading">
            <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_HqGoNM.json" background="transparent"
                speed="1" style="width: 100%; height: 140px;" loop autoplay></lottie-player>
    ...
    <div class="wrapper fullheight-side sidebar_minimize">
        ...
        <!-- jQuery UI -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js">
        </script>
        <script
        ...
        <!-- jQuery Scrollbar -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js">
        </script>
        ...
        <!-- jQuery Sparkline -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js">
        </script>
        ...
        <!-- Bootstrap Notify -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js">
        </script>
        ...
        <!-- Bootstrap Tagsinput -->
        <script
            src="{{ asset('main_asset/examples') }}/assets/js/plugin/bootstrap-tagsinput/bootstrap-tagsinput.min.js">
        </script>

        <!-- Bootstrap Wizard -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/bootstrap-wizard/bootstrapwizard.js">
        </script>

        <!-- jQuery Validation -->
        <script src="{{ asset('main_asset/examples') }}/assets/js/plugin/jquery.validate/jquery.validate.min.js">
        </script>
