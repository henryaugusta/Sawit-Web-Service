        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="card border-2 shadow rounded col-md-12 col-12">
                    <div class="card-body">
                        ...
                        <input type="text" placeholder="Masukkan Berat Sawit"
                               class="form-control" name="est_weight" required id="priceSim" aria-describedby="helpId">
                ...
                <div class="card border-2 shadow rounded col-md-12 col-12">
                    ...
                    <div class="card-body">
                        <button type="button" onclick="locateMe()" class="btn btn-primary mb-3">Arahkan Ke Lokasi Saya
                        </button>
                        <p>Letakan Pin Poin pada lokasi penjemputan anda</p>
                        <div id="mapid" style="width: 100%; height: 400px;"></div>
                        <script>
                            var mymap = L.map('mapid').setView([-7.046379, 107.555881], 993);
